...
证明：B 树的根至少包含一个关键字，而且所有其它的结点至少包含 t - 1 个关键字。因此，高度为 h 的 B 树在深度 1 至少包含 2 个结点，在深度 2 至少包含 2t 个结点，在深度 3 至少包含 2t<sup>2</sup> 个结点，等等，至少深度 h 至少有 2t<sup>n-1</sup> 个结点。下图给出了 h = 3 时的一棵树。因此，关键字的个数 n 满足不等式：
